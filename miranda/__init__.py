...
class upnp:
  ...
  def initSockets(self,ip,port,iface):
          ...
          try:
                  ...
                  if self.IFACE != None:
                          ...
                          self.ssock.setsockopt(SOL_SOCKET,SO_BINDTODEVICE,struct.pack("%ds" % (len(self.IFACE)+1,), self.IFACE))
                          self.csock.setsockopt(SOL_SOCKET,SO_BINDTODEVICE,struct.pack("%ds" % (len(self.IFACE)+1,), self.IFACE))
  ...
  def updateCmdCompleter(self,struct):
          ...
          try:
                  ...
                  print(f"Error ({e}) updating command completer structure; some command completion features might not work...")
          return
